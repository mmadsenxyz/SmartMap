...
//Name: Wall_Column_Wood_02.ma
//Last modified: Sun, Mar 23, 2008 11:51:51 PM
requires maya "6.5";
...
createNode transform -n "pCube18";
	setAttr ".t" -type "double3" 0.25 0 8.25 ;
...
createNode mesh -n "pCubeShape18" -p "pCube18";
	...
	setAttr -s 48 ".uvst[0].uvsp[0:47]" -type "float2" 0.94193256 0.64683348 
		0.88553572 0.64683348 0.94193256 0.64683348 0.88553572 0.64683348 0.88553572 0.77558023 
		0.94193256 0.77558023 0.94193256 0.82204682 0.88553572 0.82204682 0.79741967 0.64683348 
		0.74618399 0.64683348 0.74618399 0.64683348 0.79741967 0.64683348 0.89262277 0.77558023 
	...
	setAttr -s 16 ".pt[0:15]" -type "float3"  1 0 1 1.5 0 1 1 0 0.5 1.5 
		0 0.5 1 -2 1 1.5 -2 1 1 -2 0.5 1.5 -2 0.5 1 -2 1 1.5 -2 1 1 -2 1 1 -2 0.5 1.5 -2 
		1 1.5 -2 0.5 1 -2 0.5 1.5 -2 0.5;
...
connectAttr "pCubeShape18.iog" "Wall_Column_Wood_01:lambert4SG.dsm" -na;
connectAttr "pCubeShape19.iog" "Wall_Column_Wood_01:lambert4SG.dsm" -na;
connectAttr "pCubeShape21.iog" "Wall_Column_Wood_01:lambert4SG.dsm" -na;
connectAttr "pCubeShape22.iog" "Wall_Column_Wood_01:lambert4SG.dsm" -na;
