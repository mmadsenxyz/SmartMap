...
namespace SmartMap
{
	...
	public class Draw4D
    {
        ...
        public CharacterController sinbad;
        ...
        public Draw4D(Camera cam, SceneManager man)
		{
            ...
            this.sinbad = new CharacterController(cam, man);
        }
		...
		public void CreateZone(int zoneNumber, bool recreate, float mapSize, float meshSize)
		{
			...
			// create zones
			if (!recreate) {
				idraw.CreateGraphics(zone, "Zone", "Zone.mesh", "TileSet/Room", 36, 36, RenderQueueGroupID.One);
				// create 36 zoneNodes
