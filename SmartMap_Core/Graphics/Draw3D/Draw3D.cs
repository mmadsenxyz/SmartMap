    ...
    public class Draw3D : EngineSetup, IDraw, IDisposable
	{
        ...
        { 
            ...
            { //// STAGGER MODULE ////
                ...
                { 
                    clippedTileCount ++;
                    if (clippedTileCount == tileThreshhold) { // if removed tile count equals tileThreshold, remove entire module
                    ...
                    } else if (!moduleNodeDestroyed) { // remove tile 
            ...
            if (moduleNodeDestroyed == false) { // remake modified module 
                //// MAZE MODULE //// 
                ...
                if (!this.sm.GeneratePath("TILESET", false, 1, 1, 9, 0)) { // generate maze with auto or manual path - if it zonks out skip :-)   
                    return;
                }
		...
		#region Camera Clipping Events
		/*
			// ZONE SYSTEM (depeandant on pure engine coordinates)
            //////////////////////////////////////
